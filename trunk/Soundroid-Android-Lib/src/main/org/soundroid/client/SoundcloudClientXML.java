...
public class SoundcloudClientXML {
	...
	//CONSTRUCTORS
	public SoundcloudClientXML() {
		this(new DefaultHttpClient(), null);
	}

	public SoundcloudClientXML(ClientSettings cs) {
		this(new DefaultHttpClient(), cs);

	}

	public SoundcloudClientXML(final HttpClient hClient) {
		this(hClient, null);
	}

	public SoundcloudClientXML(final HttpClient hClient, ClientSettings cs) {
